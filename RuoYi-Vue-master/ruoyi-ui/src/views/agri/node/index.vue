  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        ...
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd" v-hasPermi="['agri:node:add']">新增</el-button>
    ...
    <el-dialog :title="title" :visible.sync="open" width="560px" append-to-body>
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item v-if="isAdmin && form.nodeId" label="所属用户">

          <el-input :value="queryParams.createBy || form.createBy" disabled />

        </el-form-item>

        <el-form-item v-if="isAdmin && !form.nodeId" label="所属用户" prop="createBy">

          <el-select v-model="form.createBy" placeholder="请选择用户" filterable style="width: 100%">
  ...
  methods: {
    ...
    handleAdd() {
      ...
      if (this.isAdmin) {
        ...
        this.form.createBy = this.queryParams.createBy || undefined
      ...
      this.$refs['form'].validate(valid => {
        ...
        if (valid) {
          ...
          if (this.form.nodeId != null) {
            ...
            if (this.isAdmin && !payload.createBy && this.queryParams.createBy) {
