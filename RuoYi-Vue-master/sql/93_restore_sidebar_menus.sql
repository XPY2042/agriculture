...
-- Default database name is ry-vue from application-druid.yml
-- ============================================================
...
INSERT INTO sys_menu VALUES(2104, UNHEX('E783ADE58A9BE59CB0E59BBE'), '2100', '4', 'agriHeatmap', 'agri/heatmap/index', '', 'AgriHeatmap', 1, 0, 'C', '0', '0', 'agri:monitor:view', 'component', 'admin', sysdate(), '', NULL, '');
...
INSERT INTO sys_menu VALUES(2136, UNHEX('E783ADE58A9BE69FA5E8AFA2'), '2104', '1', '', '', '', '', 1, 0, 'F', '0', '0', 'agri:monitor:view', '#', 'admin', sysdate(), '', NULL, '');
INSERT INTO sys_menu VALUES(2137, UNHEX('E5918AE8ADA6E7A1AEE8AEA4'), '2104', '2', '', '', '', '', 1, 0, 'F', '0', '0', 'agri:monitor:view', '#', 'admin', sysdate(), '', NULL, '');
