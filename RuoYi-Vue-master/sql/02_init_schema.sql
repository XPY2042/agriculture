...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '农业监测中心',   0, '负责人', '15888888888', 'contact@local', '0', '0', 'admin', sysdate(), '', null);
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  100, 'admin', '管理员', '00', 'admin@local', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '管理员');
insert into sys_user values(2,  100, 'ry',    '监测员', '00', 'user@local',  '15666666666', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '测试员');
...
-- 初始化-公告信息表数据
-- ----------------------------
insert into sys_notice values('1', '欢迎使用智慧农业监测系统', '2', '请配置传感节点并开始采集土壤与环境数据。', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice values('2', '系统维护提示', '1', '维护窗口内可能影响服务，请提前保存工作。', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice values('3', '功能说明', '1', '<p>本系统用于农田物联网监测，提供实时读数、历史趋势与作物生长建议。请在「智慧农业」菜单下维护传感节点并查看环境监测。</p>', '0', 'admin', sysdate(), '', null, '管理员');
...
-- ----------------------------
-- 21、智慧农业扩展（表 + 演示数据 + 菜单 2100-2114 + 角色2菜单）
-- ----------------------------
SET NAMES utf8mb4;
...
DELETE FROM sys_role_menu WHERE menu_id IN (2100,2101,2102,2110,2111,2112,2113,2114);
DELETE FROM sys_menu WHERE menu_id IN (2100,2101,2102,2110,2111,2112,2113,2114);

INSERT INTO sys_menu VALUES(2100, '智慧农业', '0', '5', 'agri', NULL, '', '', 1, 0, 'M', '0', '0', '', 'international', 'admin', sysdate(), '', NULL, '智慧农业目录');
-- 子路由 path 勿用 monitor：与「系统监控」目录 path 冲突，路由 name 均为 Monitor 会致 404
...
-- ----------------------------
-- 去除「系统管理」「系统监控」「系统工具」等框架菜单，侧边栏仅保留「智慧农业」(2100-2114)
-- （新库导入本脚本后侧边栏仅保留智慧农业与用户管理，无需再单独执行菜单裁剪补丁）
-- ----------------------------
DELETE FROM sys_role_menu WHERE menu_id NOT IN (2100, 2101, 2102, 2110, 2111, 2112, 2113, 2114);
DELETE FROM sys_menu WHERE menu_id NOT IN (2100, 2101, 2102, 2110, 2111, 2112, 2113, 2114);
...
INSERT IGNORE INTO sys_role_menu VALUES ('2', '2110');
...
-- ----------------------------
-- User management menus (UTF-8 hex avoids Windows import garbling)
-- ----------------------------
INSERT INTO sys_menu VALUES(2200, CONVERT(UNHEX('E7B3BBE7BB9FE7AEA1E79086') USING utf8mb4), 0, 5, 'system', NULL, '', '', 1, 0, 'M', '0', '0', '', 'system', 'admin', sysdate(), '', NULL, '');
INSERT INTO sys_menu VALUES(100, CONVERT(UNHEX('E794A8E688B7E7AEA1E79086') USING utf8mb4), 2200, 1, 'user', 'system/user/index', '', '', 1, 0, 'C', '0', '0', 'system:user:list', 'user', 'admin', sysdate(), '', NULL, CONVERT(UNHEX('E7B3BBE7BB9FE794A8E688B7E7BBB4E68AA4') USING utf8mb4));
INSERT INTO sys_menu VALUES(1000, CONVERT(UNHEX('E794A8E688B7E69FA5E8AFA2') USING utf8mb4), 100, 1, '', '', '', '', 1, 0, 'F', '0', '0', 'system:user:query',   '#', 'admin', sysdate(), '', NULL, '');
INSERT INTO sys_menu VALUES(1001, CONVERT(UNHEX('E794A8E688B7E696B0E5A29E') USING utf8mb4), 100, 2, '', '', '', '', 1, 0, 'F', '0', '0', 'system:user:add',     '#', 'admin', sysdate(), '', NULL, '');
INSERT INTO sys_menu VALUES(1002, CONVERT(UNHEX('E794A8E688B7E4BFAEE694B9') USING utf8mb4), 100, 3, '', '', '', '', 1, 0, 'F', '0', '0', 'system:user:edit',    '#', 'admin', sysdate(), '', NULL, '');
INSERT INTO sys_menu VALUES(1003, CONVERT(UNHEX('E794A8E688B7E588A0E999A4') USING utf8mb4), 100, 4, '', '', '', '', 1, 0, 'F', '0', '0', 'system:user:remove',  '#', 'admin', sysdate(), '', NULL, '');
INSERT INTO sys_menu VALUES(1004, CONVERT(UNHEX('E794A8E688B7E5AFBCE587BA') USING utf8mb4), 100, 5, '', '', '', '', 1, 0, 'F', '0', '0', 'system:user:export',  '#', 'admin', sysdate(), '', NULL, '');
INSERT INTO sys_menu VALUES(1005, CONVERT(UNHEX('E794A8E688B7E5AFBCE585A5') USING utf8mb4), 100, 6, '', '', '', '', 1, 0, 'F', '0', '0', 'system:user:import',  '#', 'admin', sysdate(), '', NULL, '');
INSERT INTO sys_menu VALUES(1006, CONVERT(UNHEX('E9878DE7BDAEE5AF86E7A081') USING utf8mb4), 100, 7, '', '', '', '', 1, 0, 'F', '0', '0', 'system:user:resetPwd','#', 'admin', sysdate(), '', NULL, '');
-- 农业管理员 role_id=3：用户管理 + 智慧农业（若角色不存在可忽略）
INSERT IGNORE INTO sys_role_menu VALUES ('3', '100');
INSERT IGNORE INTO sys_role_menu VALUES ('3', '1000');
INSERT IGNORE INTO sys_role_menu VALUES ('3', '1001');
INSERT IGNORE INTO sys_role_menu VALUES ('3', '1002');
INSERT IGNORE INTO sys_role_menu VALUES ('3', '1003');
INSERT IGNORE INTO sys_role_menu VALUES ('3', '1004');
INSERT IGNORE INTO sys_role_menu VALUES ('3', '1005');
INSERT IGNORE INTO sys_role_menu VALUES ('3', '1006');
...
INSERT IGNORE INTO sys_role_menu VALUES ('3', '2110');
